...
class build_graph:
    ...
    def __init__(self,config, audio_feats, video_feats, adj_matrices):
        ...
        # audio, video feature 
        self.a_feat = audio_feats # (n_samples, sequence_length=n_nodes, audio_feature_dim)
        self.v_feat = video_feats # (n_samples, sequence_length=n_nodes, video_feature_dim)
